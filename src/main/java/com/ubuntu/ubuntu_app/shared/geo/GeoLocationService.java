...
import com.ubuntu.ubuntu_app.shared.error.GeocodeErrorException;
...
public class GeoLocationService {
    ...
    public ResponseEntity<Map<String, LocationDTO>> obtainUserLocation(double latitude, double longitude) {
    ...
    private LocationDTO getLocation(double latitude, double longitude) {
        String url = UriComponentsBuilder.fromUriString(nominatimProperties.reverse())
