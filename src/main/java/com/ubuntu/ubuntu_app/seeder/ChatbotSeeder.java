        ...
        private void loadChatbot() {
                List<FAQEntity> listSQL = Arrays.asList(
                                ...
                                new FAQEntity("buenos dias",
                                                "¡Bienvenido a Ubuntu! Estamos emocionados de ayudarte a encontrar oportunidades de inversión que no solo generen ganancias, sino que también promuevan un impacto positivo en el medio ambiente y la sociedad. ¿En qué tipo de proyectos sustentables estás interesado hoy? ¡Estoy aquí para ayudarte a explorar y encontrar las mejores opciones para ti!"),
                                new FAQEntity("Adios", "Adios! Espero que hayas resuelto todas tus dudas"),
                                new FAQEntity("chau", "Adios! Espero que hayas resuelto todas tus dudas"),
                                new FAQEntity("nos vemos", "Adios! Espero que hayas resuelto todas tus dudas"),
                                new FAQEntity("hasta luego", "Adios! Espero que hayas resuelto todas tus dudas"),
                                new FAQEntity("Saludos", "Adios! Espero que hayas resuelto todas tus dudas"),
                                new FAQEntity("comosalir",
                                                "Para cerrar el chatbot solo presiona cualquier parte fuera de esta ventana =)"),
                                new FAQEntity("comocerrar",
                                                "Para cerrar el chatbot solo presiona cualquier parte fuera de esta ventana =)"),
                                new FAQEntity("comosalgo",
                                                "Para cerrar el chatbot solo presiona cualquier parte fuera de esta ventana =)"),
                                new FAQEntity("quiero cerrar",
                                                "Para cerrar el chatbot solo presiona cualquier parte fuera de esta ventana =)"),
                                new FAQEntity("ayuda", "¿En que te puedo ayudar?"),
                                new FAQEntity("tengo duda", "¿En que te puedo ayudar?"),
                                new FAQEntity("no enlace",
                                                "Al parecer el enlace no está cargado, lo siento mucho. Haremos todo lo posible para que esté disponible!"),
                                new FAQEntity("quiero registro",
                                                "Para registrarte podes hacer click desde la solapa izquierda"),
                                new FAQEntity("quiero registrarme en la web",
                                                "Para registrarte podes hacer click desde la solapa izquierda"),
                                new FAQEntity("como registrarme",
                                                "Para registrarte podes hacer click desde la solapa izquierda"),
                                new FAQEntity("registra",
                                                "Para registrarte podes hacer click desde la solapa izquierda"),
                                // objetivos empresa
                                new FAQEntity("ubuntu",
                                                "Somos un grupo de personas que brindamos la posibilidad de conectar a los inversores de impacto con los proyectos de microemprendedores conociendo su propósito, contexto historia que motive a los inversores y con los proyectos para apalancar financieramente a empresas u organizaciones que busquen generar un impacto positivo"),
                                ...
                                new FAQEntity("que rubro pertenece", "finanzas"),
                                new FAQEntity("como los contacto", "Para contactarnos...."),
                                new FAQEntity("contactar", "Para contactarnos...."),
                                new FAQEntity("como podria contactarlos", "Para contactarnos...."),
                                new FAQEntity("quiero contactar", "Para contactarnos...."),
                                // categorias
                                ...
                                new FAQEntity("invertir",
                                                "Tenemos microemprendimientos que estan compuestas por categorías estas pueden ser de  Economía social/Desarrollo local/Inclusión financiera\n"
                                                                + "\n"
                                                                + "Agroecología/Orgánicos/Alimentación saludable, Empresas/Organismos de impacto/Economía circular,  Conservación/Regeneración/Servicios ecosistémicos. Para saber mas pueder ir al siguiente enlace. "),
                                new FAQEntity("categoria",
                                                "Tenemos microemprendimientos que estan compuestas por categorías estas pueden ser de  Economía social/Desarrollo local/Inclusión financiera\n"
                                                                + "\n"
                                                                + "Agroecología/Orgánicos/Alimentación saludable, Empresas/Organismos de impacto/Economía circular,  Conservación/Regeneración/Servicios ecosistémicos. Para saber mas pueder ir al siguiente enlace. "),
                                new FAQEntity("cuales son las categorias",
                                                "Tenemos microemprendimientos que estan compuestas por categorías estas pueden ser de  Economía social/Desarrollo local/Inclusión financiera\n"
                                                                + "\n"
                                                                + "Agroecología/Orgánicos/Alimentación saludable, Empresas/Organismos de impacto/Economía circular,  Conservación/Regeneración/Servicios ecosistémicos. Para saber mas pueder ir al siguiente enlace. "),
