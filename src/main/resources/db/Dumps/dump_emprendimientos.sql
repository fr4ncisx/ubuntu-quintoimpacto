...
CREATE TABLE IF NOT EXISTS `microbusinesses` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK2s9ucw3bp1xjo9f63gk88kxaw` (`category_id`),
  CONSTRAINT `FK2s9ucw3bp1xjo9f63gk88kxaw` FOREIGN KEY (`category_id`) REFERENCES `categorias` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

DELETE FROM `microbusinesses`;
/*!40000 ALTER TABLE `microbusinesses` DISABLE KEYS */;
INSERT INTO `microbusinesses` (`id`, `active`, `city`, `description`, `reviewed`, `images`, `more_info`, `name`, `country`, `province`, `subcategory`, `category_id`) VALUES
...
/*!40000 ALTER TABLE `microbusinesses` ENABLE KEYS */;
